...
class App:
    ...
    def show_inventory(self):
        ...
        labels = [
            ...
            "Consumption", "Ending Balance", "Beginning Balance"
        ]
    ...
    def add_data(self):
        ...
        beginning_balance = float(self.create_entry["Beginning Balance"].get() or 0)
        ...
        self.cursor.execute('''
        INSERT INTO inventory (raw_code, whse1_buo, whse1_excess, whse2_buo, whse2_excess, whse4_buo, whse4_excess, whse1_terumo, whse1_prepare, in_value, out_value, consumption, ending_balance, beginning_balance)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        ''', (raw_code, whse1_buo, whse1_excess, whse2_buo, whse2_excess, whse4_buo, whse4_excess, whse1_terumo, whse1_prepare, in_value, out_value, consumption, ending_balance, beginning_balance))
    ...
    def update_data(self):
        ...
        ending_balance = self.calculate_ending_balance(whse1_buo, whse1_excess, whse2_buo, whse2_excess, whse4_buo, whse4_excess, whse1_terumo, whse1_prepare, in_value, out_value, consumption, beginning_balance)
        ...
        self.cursor.execute('''
        UPDATE inventory SET raw_code=?, whse1_buo=?, whse1_excess=?, whse2_buo=?, whse2_excess=?, whse4_buo=?, whse4_excess=?, whse1_terumo=?, whse1_prepare=?, in_value=?, out_value=?, consumption=?, ending_balance=? beginning_balance=? WHERE id=?
        ''', (raw_code, whse1_buo, whse1_excess, whse2_buo, whse2_excess, whse4_buo, whse4_excess, whse1_terumo, whse1_prepare, in_value, out_value, consumption, ending_balance, beginning_balance, row_id,))
